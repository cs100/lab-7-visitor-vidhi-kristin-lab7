...
void Op::accept(Visitor *pointer) {pointer->opNode(this);}
...
void Add::accept(Visitor *pointer) {pointer->addNode();}
...
void Sub::accept(Visitor *pointer) {pointer->subNode();}
...
void Mult::accept(Visitor *pointer) {pointer->multNode();}
...
void Sqr::accept(Visitor *pointer) {pointer->sqrNode();}
...
void Root::accept(Visitor *pointer) {pointer->rootNode();}